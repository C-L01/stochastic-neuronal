...
\red{TODO: Actually, not sure about the right-continuity assumption, because the natural filtration of a right-continuous process is not necessarily right-continuous. These concepts are very much unrelated, see https://math.stackexchange.com/questions/3316024/mathcal-f-t-mathcal-f-t-iff-x-t-is-right-continuous?rq=1. Could maybe use Chung (1982,
