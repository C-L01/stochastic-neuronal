...
\begin{lemma}
  For the empirical measure curve as defined in \zcref{def:emp-measure}, we have \(\mu^{\lambda,N} \in D_{\cP(\potspace)}[0,T]\).
\end{lemma}
